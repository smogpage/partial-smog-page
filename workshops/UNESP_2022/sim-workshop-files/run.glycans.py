...
#Choose some basic runtime settings.  We will call our system spike 
SMOGrun = SBM(name='spike', time_step=0.002, collision_rate=1.0, r_cutoff=0.65, temperature=0.5)
...
SMOGrun.saveFolder('output_spike')

#You may optionally set some input file names to variables
SMOG_grofile = 'spike.OpenSMOG.AA+glycans.gro'
SMOG_topfile = 'spike.OpenSMOG.AA+glycans.top'
SMOG_xmlfile = 'spike.OpenSMOG.AA+glycans.xml'
...
SMOGrun.run(nsteps=2*10**4, report=True, interval=5*10**2)
