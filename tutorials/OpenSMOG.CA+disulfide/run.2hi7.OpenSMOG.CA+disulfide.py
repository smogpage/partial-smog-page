...
SMOGrun = SBM(name='2hi7', time_step=0.0005, collision_rate=1.0, r_cutoff=1.1, temperature=0.5)
...
SMOGrun.saveFolder('output_2hi7')

#You may optionally set some input file names to variables
SMOG_grofile = '2hi7.OpenSMOG.CA+disulfide.gro'
SMOG_topfile = '2hi7.OpenSMOG.CA+disulfide.top'
SMOG_xmlfile = '2hi7.OpenSMOG.CA+disulfide.xml'
