...
SMOGrun = SBM(name='3p63', time_step=0.002, collision_rate=1.0, r_cutoff=0.65, temperature=0.5)
...
SMOGrun.saveFolder('output_3p63')

#You may optionally set some input file names to variables
SMOG_grofile = '3p63.OpenSMOG.AA+novelLigand.gro'
SMOG_topfile = '3p63.OpenSMOG.AA+novelLigand.top'
SMOG_xmlfile = '3p63.OpenSMOG.AA+novelLigand.xml'
