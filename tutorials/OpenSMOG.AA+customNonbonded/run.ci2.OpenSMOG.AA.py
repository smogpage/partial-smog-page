...
SMOGrun = SBM(name='2ci2', time_step=0.002, collision_rate=1.0, r_cutoff=2, temperature=0.5)
...
SMOG_grofile = '2ci2.OpenSMOG.AA+customNonbonded.gro'
SMOG_topfile = '2ci2.OpenSMOG.AA+customNonbonded.top'
SMOG_xmlfile = '2ci2.OpenSMOG.AA+customNonbonded.xml'
