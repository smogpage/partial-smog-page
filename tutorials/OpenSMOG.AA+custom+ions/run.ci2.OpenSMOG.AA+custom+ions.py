...
SMOG_grofile = '2ci2.OpenSMOG.AA+custom+ions.MGCL.gro'
SMOG_topfile = '2ci2.OpenSMOG.AA+custom+ions.MGCL.top'
SMOG_xmlfile = '2ci2.OpenSMOG.AA+custom+ions.MGCL.xml'
