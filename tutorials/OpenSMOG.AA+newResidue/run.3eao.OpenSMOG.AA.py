...
SMOGrun = SBM(name='3eao', time_step=0.002, collision_rate=1.0, r_cutoff=0.65, temperature=0.5)
...
SMOGrun.saveFolder('output_3eao')

#You may optionally set some input file names to variables
SMOG_grofile = '3eao.noligands.gro'
SMOG_topfile = '3eao.noligands.top'
SMOG_xmlfile = '3eao.noligands.xml'
