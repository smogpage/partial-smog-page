...
SMOGrun = SBM(name='2hi7', time_step=0.002, collision_rate=1.0, r_cutoff=0.65, temperature=0.5)
...
SMOG_grofile = '2hi7.OpenSMOG.AA+disulfide.gro'
SMOG_topfile = '2hi7.OpenSMOG.AA+disulfide.top'
SMOG_xmlfile = '2hi7.OpenSMOG.AA+disulfide.xml'
