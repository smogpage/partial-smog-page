...
SMOGrun = SBM(name='2ci2', time_step=0.002, collision_rate=1.0, r_cutoff=0.65, temperature=0.5)
...
SMOG_grofile = '2ci2.OpenSMOG.AA+customContacts.gro'
SMOG_topfile = '2ci2.OpenSMOG.AA+customContacts.top'
SMOG_xmlfile = '2ci2.OpenSMOG.AA+customContacts.xml'
